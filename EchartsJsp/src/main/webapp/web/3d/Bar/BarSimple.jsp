...
{0,43,2.85433200756905}};
    ...
    <table>
        <tr>
            <td>
                <echar3D:echartBar3DSimple dataValues="<%=dataValues%>" idCharts="main" z3DMinMax="<%=z3DMinMax%>" />
    
            </td>
        </tr>
        <tr>
            <td>
                <echar3D:echartBar3DSimple dataValues="<%=dataValues%>" grid3DboxWidthDepth="<%=grid3DboxWidthDepth%>" seriesTypeEchart="surface" idCharts="mainx" />
            </td>
        </tr>
    </table>
    </div>
